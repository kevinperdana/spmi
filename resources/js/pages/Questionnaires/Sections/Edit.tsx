...
export default function Edit({ page, section }: Props) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Edit Section', href: `/questionnaires/${page.id}/sections/${section.id}/edit` },
    ];

    const submit: FormEventHandler = (event) => {
        event.preventDefault();
        patch(`/questionnaires/${page.id}/sections/${section.id}`);
    };
