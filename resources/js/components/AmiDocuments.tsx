                ...
                <div className="spmi-track" ref={trackRef}>
                    {section.documents.map((document) => (
                        ...
                        >
                            ...
                            <div className="spmi-card__cta">View {downloadArrow}</div>
                        </button>
                    ))}
                </div>
...
export default function AmiDocuments({ label, sections }: AmiDocumentsProps) {
            ...
            <div className="spmi-fasilitas">
                <div className="spmi-fasilitas__grid">
                    <div className="spmi-fasilitas__side">
                        <div className="spmi-fasilitas__vert">{label.toUpperCase()}</div>
                    </div>
